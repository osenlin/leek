...
class testBase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        os.environ['SPARK_HOME'] = "/Users/linzhihuang/Downloads/spark-2.2.0-bin-hadoop2.7"
        sys.path.append("/Users/linzhihuang/Downloads/spark-2.2.0-bin-hadoop2.7/python")
        conf = SparkConf()
